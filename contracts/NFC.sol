...
contract NFTAMM {
    ...
    function addLiquidityWithFT(
        ...
        */
        ...
        _update(
            ...
            _token0,
            _token1,
            reserve[findLpToken[_token1][_token0]][_token0] + _amount0,
            reserve[findLpToken[_token1][_token0]][_token1] + _amount1
        );
    }

    function _creatpairLogic(
        address _token0,
        address _token1,
        uint _amount0,
        uint _amount1,
        ...
        rewardToken.mint(
            msg.sender,
            calculate.calculateRewardTokenAmount(0, _amount0)
        );
    }

    function _pairCreatedLogic(
        address _token0,
        address _token1,
        uint _amount0,
        uint _amount1,
        ...
        rewardToken.mint(
            _user,
            calculate.calculateRewardTokenAmount(
    ...
    function addLiquidity(
        ...
        */
        if (findLpToken[_token1][_token0] != address(0)) {
            lptokenAddr = findLpToken[_token1][_token0];
            _amount1 =
                (reserve[lptokenAddr][_token1] * _amount0) /
                reserve[lptokenAddr][_token0];
            IERC20 token1 = IERC20(_token1);
        ...
        _update(
            ...
            _token0,
            _token1,
            reserve[lptokenAddr][_token0] + _amount0,
            reserve[lptokenAddr][_token1] + _amount1
        );
    }
    ...
    function removeLiquidity(
        ...
        if (pairCreator[lptokenAddr] == msg.sender) {
            require(
                lptoken.balanceOf(msg.sender) - _shares > 100,
                "paieCreator should left 100 wei lptoken in pool"
            );
        }
        ...
        _update(
            ...
            _token0,
            _token1,
            reserve[lptokenAddr][_token0] - amount0,
            reserve[lptokenAddr][_token1] - amount1
        );
    ...
    function createPair(
        ...
        bytes32 _salt = keccak256(abi.encodePacked(addrToken0, addrToken1));
    ...
    function createRewardToken(
        ...
        bytes32 _salt = keccak256(
            abi.encodePacked("RewardToken", addrToken0, addrToken1)
        );
        new LPToken{salt: bytes32(_salt)}();
